...
class PlayList(models.Model):
    ...
    deleted_at = models.DateTimeField(
        blank=True, null=True, verbose_name='삭제된 날짜')
    ...
    category = models.CharField(
        blank=True, null=True, max_length=32, choices=CATEGORY, verbose_name='범주')
    star_rating = models.PositiveSmallIntegerField(
        blank=True, null=True, choices=STARS, default=ONE_STAR, verbose_name='곡 선호도')
